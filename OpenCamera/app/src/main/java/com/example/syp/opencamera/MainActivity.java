package com.example.syp.opencamera;
...
import com.example.syp.opencamera.databinding.ActivityMainBinding;
 ...
 * 授权    eg:动态获取权限调用系统照相机
 * <p>
 * checkSelfPermission要在build中把15改成23
 */
...
//            }
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                new AlertDialog.Builder(MainActivity.this)
                        .setTitle("提醒")
                        .setMessage("您没有授权该应用 使用摄像机,是否现在授权?")
